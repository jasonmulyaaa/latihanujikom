...
<div class="content-wrapper bg-white">
          <div class="row">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Verifikasi dan Validasi Table</h4>
                      ...
                      @endif
                        ...
                        @foreach ($verifikasis as $verifikasi)
                          <tr>
                            ...
                            <td>
                              <div @if($verifikasi->status == 'selesai') class="badge badge-opacity-success" @elseif($verifikasi->status == 'proses') class="badge badge-opacity-warning" @else class="badge badge-opacity-secondary" @endif>{{ $verifikasi->status}}</div>
                            </td>
                            <td>
                            {{-- <form action="{{ route('verifikasi.destroy', $verifikasi->id_pengaduan) }}" method="POST"> --}}
                            ...
                            <button type="submit" class="btn rounded-pill btn-warning">Verifikasi</button>
                            </form>
                            {{-- @csrf
                            @method('DELETE')
